...
public class FlowFrameworkIndicesHandlerTests extends OpenSearchTestCase {
    ...
    // flowMock.initFlowFrameworkIndexIfAbsent(any(FlowFrameworkIndex.class), any());
    // // when(flowFrameworkIndicesHandler.initFlowFrameworkIndexIfAbsent(flowFrameworkIndex, listener).
    //// flowFrameworkIndicesHandler.initFlowFrameworkIndexIfAbsent(listener);
    // //verify(flowMock).initFlowFrameworkIndexIfAbsent(any(FlowFrameworkIndex.class), any());
