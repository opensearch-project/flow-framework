...
public class JsonToJsonRecommenderTests extends OpenSearchTestCase {
    public void testSimpleNestedStructures() throws JsonProcessingException, IllegalArgumentException {
        ...
        // Verify that the actual output contains the expected structure (ignoring whitespace differences)
        assertTrue(
    ...
    public void testVerbose() throws JsonProcessingException, IllegalArgumentException {
        String inputJson = """
            {
              "level1": {
                "level2": {
        ...
        /* Expected verbose output should contain:
        ...
        // Verify that the verbose output contains expected mappings (ignoring formatting differences)
        assertTrue("Verbose should contain detailed field mapping header", verbose.contains("Detailed Field Mapping:"));
        assertTrue("Verbose should contain generalized field mapping header", verbose.contains("Generalized Field Mapping:"));
        assertTrue("Verbose should contain output title", verbose.contains("Output Field"));
        assertTrue("Verbose should contain input title", verbose.contains("Input Field"));
        assertTrue("Verbose should contain output field", verbose.contains("$.result.nested.info.value"));
        assertTrue("Verbose should contain input field", verbose.contains("$.level1.level2.level3.data"));
    ...
    public void testArrayToArrayWithGeneralized() throws JsonProcessingException, IllegalArgumentException {
        ...
        // Verify that the actual output contains expected mappings (ignoring formatting differences)
        assertTrue(
    ...
    public void testArrayToArrayCannotBeGeneralized() throws JsonProcessingException, IllegalArgumentException {
        ...
        // Since arrays cannot be generalized (different values), both outputs should be the same
        assertTrue(
    ...
    public void testGetRecommendationErrorHandlingForEmptyInputs() {
        // Test empty inputs
        expectThrows(IllegalArgumentException.class, () -> JsonToJsonRecommender.getRecommendation("", "{}"));
    ...
    public void testGetRecommendationWithInvalidJson() {
        ...
        expectThrows(JsonProcessingException.class, () -> JsonToJsonRecommender.getRecommendation(invalidJson, validJson));

        // Should throw JsonProcessingException for invalid output JSON
        expectThrows(JsonProcessingException.class, () -> JsonToJsonRecommender.getRecommendation(validJson, invalidJson));
    }

    public void testGetRecommendationWithOversizedJson() {
        // Create a large JSON string that exceeds the StreamReadConstraints limit (50MB)
        ...
        JsonProcessingException inputException = expectThrows(
            ...
            () -> JsonToJsonRecommender.getRecommendation(largeJson, validJson)
        );
        assertTrue(
            "Exception message should mention string value length exceeds maximum",
            inputException.getMessage().contains("Failed to parse input JSON")
        ...
        JsonProcessingException outputException = expectThrows(
            JsonProcessingException.class,
            () -> JsonToJsonRecommender.getRecommendation(validJson, largeJson)
        );
        assertTrue(
            "Exception message should mention string value length exceeds maximum",
            outputException.getMessage().contains("Failed to parse output JSON")
    ...
    public void testGetRecommendationWithOversizedFieldName() {
        // Create a JSON string with field name that exceeds the MAX_NAME_LEN limit (50000 characters)
        ...
        JsonProcessingException inputException = expectThrows(
            JsonProcessingException.class,
            () -> JsonToJsonRecommender.getRecommendation(inputJsonWithLongFieldName, validJson)
        );
        assertTrue(
        ...
        JsonProcessingException outputException = expectThrows(
            JsonProcessingException.class,
            () -> JsonToJsonRecommender.getRecommendation(validJson, inputJsonWithLongFieldName)
        );
        assertTrue(
            "Exception message should mention field name length exceeds maximum",
            outputException.getMessage().contains("Failed to parse output JSON")
    ...
    public void testGetRecommendationWithDeeplyNestedJson() {
        ...
        JsonProcessingException inputException = expectThrows(
            JsonProcessingException.class,
            () -> JsonToJsonRecommender.getRecommendation(deepJson, validJson)
        );
        assertTrue(
        ...
        JsonProcessingException outputException = expectThrows(
            JsonProcessingException.class,
            () -> JsonToJsonRecommender.getRecommendation(validJson, deepJson)
        );
        assertTrue(
