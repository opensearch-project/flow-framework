...
public class JsonToJsonRecommender {
     ...
     * This limit prevents excessive memory usage and potential DoS attacks.
     */
    private static final int MAX_JSON_SIZE = XContentContraints.DEFAULT_MAX_STRING_LEN; // 50000000
    private static final int MAX_NAME_LENGTH = XContentContraints.DEFAULT_MAX_NAME_LEN; // 50000

    /**
     * Maximum allowed nesting depth for JSON structures.
     * This limit prevents stack overflow errors during recursive processing.
     */
    private static final int MAX_NESTING_DEPTH = XContentContraints.DEFAULT_MAX_DEPTH; // 1000
     ...
     * {@link #getRecommendation(String, String, boolean)}
     ...
     */
    public static MappingOutput getRecommendation(String inputJson, String outputJson) throws IllegalArgumentException,
     ...
     * @param inputJson   Input JSON string to analyze
     * @param outputJson  Output JSON string to map against
     * @param showDetails If true, includes formatted detailed output in the verbose
     *                    field;
     ...
     */
    public static MappingOutput getRecommendation(String inputJson, String outputJson, boolean showDetails) throws IllegalArgumentException,
        JsonProcessingException {
        // Input validation
        validateInputs(inputJson, outputJson);
        ...
        try {
            ...
            throw new JsonProcessingException("Failed to parse input JSON: " + e.getMessage(), e) {
            };
        }

        try {
            outputNode = MAPPER.readTree(outputJson);
        } catch (Exception e) {
            throw new JsonProcessingException("Failed to parse output JSON: " + e.getMessage(), e) {
            };
        }
        ...
        String detailedJsonPathString = "";
        try {
            detailedJsonPathString = MAPPER.writerWithDefaultPrettyPrinter().writeValueAsString(toNestedMapping(result.detailedJsonPath));
        } catch (Exception e) {
            throw new JsonProcessingException("Failed to generate detailed JSON path string: " + e.getMessage(), e) {
            };
        }

        String generalizedJsonPathString = "";
        try {
            generalizedJsonPathString = MAPPER.writerWithDefaultPrettyPrinter()
                .writeValueAsString(toNestedMapping(result.generalizedJsonPath));
        } catch (Exception e) {
            throw new JsonProcessingException("Failed to generate generalized JSON path string: " + e.getMessage(), e) {
            };
        }
     ...
     */
    public static String getRecommendationDetailed(String inputJson, String outputJson) throws IllegalArgumentException,
        JsonProcessingException {
        return getRecommendation(inputJson, outputJson, true).detailedJsonPathString;
    }
     ...
     */
    public static String getRecommendationGeneralized(String inputJson, String outputJson) throws IllegalArgumentException,
        JsonProcessingException {
        return getRecommendation(inputJson, outputJson, false).generalizedJsonPathString;
    }

    /**
     * Generates verbose output for a given input and output JSON
     *
     * @param inputJson
     * @param outputJson
     * @return Verbose output as a formatted string
     */
    public static String getRecommendationVerbose(String inputJson, String outputJson) throws IllegalArgumentException,
        JsonProcessingException {
        return getRecommendation(inputJson, outputJson, true).verbose;
    }
     ...
     */
    private static void validateInputs(String inputJson, String outputJson) throws IllegalArgumentException {
     ...
     * generalized mappings, with special handling for arrays to provide useful
     * transformation
     * patterns.
     *
     ...
     */
    private static MappingResult generateMappings(JsonNode outputNode, Map<String, String> inputIndex, String path) {
     ...
     */
    private static String formatJsonPath(Map<String, String> mapping) {
     ...
     */
    private record MappingResult(Map<String, String> detailedJsonPath, Map<String, String> generalizedJsonPath) {
    }
