...
public final class JsonToJsonTransformer {
     ...
     * @throws JsonProcessingException if either input cannot be parsed or the
    ...
    public static String transform(String inputJson, String mappingRules) throws IllegalArgumentException, JsonProcessingException {
        ...
        Object document;
        try {
            document = JsonPath.using(JSON_PATH_CFG).parse(inputJson).json();
        } catch (Exception e) {
            throw new JsonProcessingException("Failed to parse input JSON in JsonPath Engine", e) {
            };
        }
     ...
     * @param inputDocument the source document
     */
    private static void buildOutputFromMapping(ObjectNode outputNode, JsonNode mappingNode, Object inputDocument) {
        ...
        while (fields.hasNext()) {
            ...
            if (isArrayProperty(propertyKey)) {
                ...
                ObjectNode nestedOutputNode = outputNode.with(propertyKey);
     ...
     * @param inputDocument the source document
     */
    private static void processSimpleProperty(ObjectNode outputNode, String propertyKey, JsonNode jsonPathNode, Object inputDocument) {
     ...
     * @param inputDocument source document
     * @return determined array size
     */
    private static int determineArraySize(JsonNode elementMapping, Object inputDocument) {
